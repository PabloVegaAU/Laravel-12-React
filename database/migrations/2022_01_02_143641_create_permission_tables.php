...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        // Obtener la instancia de PermissionRegistrar una vez
        $permissionRegistrar = app(PermissionRegistrar::class);

        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('name', 125); // Longitud explícita recomendada para compatibilidad
            $table->string('guard_name', 125); // Longitud explícita recomendada para compatibilidad
            $table->timestamps();
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams, $permissionRegistrar) {
            // Usar la propiedad de la instancia
