  ...
  },
  {
    ...
    renderCell: (materia) => (
      <div className='flex flex-wrap gap-4'>
        <Button asChild variant='show' size='sm'>
          <Link href={route('admin.materias.show', materia.id)}>Ver</Link>
        </Button>

        <Button asChild variant='edit' size='sm'>
          <Link href={route('admin.materias.edit', materia.id)}>Editar</Link>
        </Button>

        <Button asChild variant='delete' size='sm'>
          <Link href={route('admin.materias.destroy', materia.id)} method='delete'>
            Eliminar
          </Link>
        </Button>
      </div>
