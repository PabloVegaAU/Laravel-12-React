...
const columns: Column<Seccion>[] = [
  ...
  {
    accessorKey: 'grado-nivel',
    header: 'GRADO NIVEL',
    renderCell: (seccion) => seccion.grado.grado + ' ' + seccion.grado.nivel
  },
  {
    ...
    renderCell: (seccion) => (
      <div className='flex flex-wrap gap-4'>
        <Link
          href={route('secciones.show', seccion.id)}
        ...
        <Link
          href={route('secciones.destroy', seccion.id)}
          method='delete'
