...
class GradoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $exists = Grado::where('grado', $request->grado)->where('nivel', $request->nivel)->first();
            if ($exists) {
            ...
            return redirect()->route('grados.index')->with('message', 'Grado creado correctamente')->with('level', 'notice');
        } catch (\Throwable $e) {
    ...
    public function destroy(string $id)
    {
        $grado = Grado::findOrFail($id);
        $grado->delete();
        return redirect()->route('grados.index')->with('message', 'Grado eliminado correctamente')->with('level', 'notice');
    }
}
