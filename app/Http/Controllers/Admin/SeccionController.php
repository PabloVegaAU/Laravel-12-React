...
class SeccionController extends Controller
{
    ...
    {
        $secciones = Seccion::with('grado')->paginate(6)->withQueryString();
    ...
    public function create()
    {
        ...
        return Inertia::render('admin/secciones/create', compact('listasec', 'grados', 'selectgr'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('secciones.index')->with('message', 'Sección creada correctamente')->with('level', 'notice');
        } catch (\Throwable $e) {
    ...
    public function destroy(string $id)
    {
        ...
        $seccion->delete();
        return redirect()->route('secciones.index')->with('message', 'Sección eliminado correctamente')->with('level', 'notice');
    }
}
