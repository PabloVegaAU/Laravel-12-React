...
class AlumnoController extends Controller
{
    ...
    {
        $alumnos = Alumno::with(['user.perfil', 'aulaActual.aula.grado', 'aulaActual.aula.seccion'])
            ->paginate(6)
            ->withQueryString();
    ...
    public function create()
    {
        ...
        $aulas = Aula::with('grado', 'seccion')->get();

        return Inertia::render('admin/alumnos/create', compact('users', 'aulas'));
    }
